public class TestClass {  //OBJECT CLASS

    String name; 
    String addy;
    String city;
    String phNum;
    TestClass next; /// Creates reference to next node in linkedList. From class 10/25

    public TestClass (String name, String addy, String city, String phNum){  //this is a contstructor
        this.name = name;
        this.addy = addy;
        this.city = city;
        this.phNum = phNum;
